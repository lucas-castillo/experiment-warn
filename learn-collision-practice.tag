<learn-collision-practice>
    ...
    <script>
        ...
        self.onInit = function () {
            ...
            self.rectangle.squareList[1].startPosition[1] = self.rectangle.squareList[1].startPosition[1] + 100
            self.rectangle.squareList[1].finalPosition[0] = self.rectangle.squareList[0].finalPosition[0]
            self.rectangle.squareList[1].finalPosition[1] = self.rectangle.squareList[1].finalPosition[1] + 100
