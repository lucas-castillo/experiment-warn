<test-collision>
    ...
    <script>
        ...
        self.onInit = function () {
            ...
            self.rectangle = new self.MovingDisplay(self.colours, self.mirroring, "reversed", false, self.squareDimensions, self.refs.myCanvas, null, self.speed, false);
            
            self.rectangle2 = new self.MovingDisplay(self.colours, self.mirroring, "reversed", false, self.squareDimensions, self.refs.myCanvas2, null, self.speed, false);
            
            self.orders = [[0,1,2], [0,2,1]]
